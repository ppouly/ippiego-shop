...
export const metadata = {
  title: "입피고 | 환불보장, 수입 유아동복 중고 마켓 IPPIE Go!",
  description: "보보쇼즈, 미니로디니 등 수입 유아동복 중고 마켓, 멋은 그대로, 부담은 덜게, 입피고는 환불가능하니까, 먼저 입혀보세요",
  keywords: [
   '보보쇼즈 중고', '미니로디니 중고','던스 순무','보보쇼즈 딸기','아폴리나 중고','루이스미샤 중고','타오 중고', '중고 아동복', '수입 아동복',"입피고",
  ],
  ...
  twitter: {
    ...
    title: "입히고샵 | 환불보장, 수입 유아동복 중고 마켓 IPPIE Go!",
